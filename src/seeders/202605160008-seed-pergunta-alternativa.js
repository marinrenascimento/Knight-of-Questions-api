export async function up({ queryInterface }) {
    ...
    if (sequelize) {
        await sequelize.query(`SELECT setval('"Perguntas_id_seq"', (SELECT MAX(id) FROM "Perguntas"));`);
        await sequelize.query(`SELECT setval('"Alternativas_id_seq"', (SELECT MAX(id) FROM "Alternativas"));`);
    }
}
